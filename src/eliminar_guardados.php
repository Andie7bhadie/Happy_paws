...
$id_guardados = $datos->id_guardados;
...
$sentencia = $connect->prepare("DELETE FROM guardados WHERE id_guardado = ?");
$sentencia->bind_param("i", $id_guardados); // "i" indica que el parámetro es un entero
